...
yum -y install php53 php53-cli php53-common php53-devel php53-pear php53-gd php53-mbstring php53-mysql php53-xml php53-bcmath gd

yum -y install OpenIPMI libssh2 libssh2-devel fping libcurl net-snmp gcc automake curl-devel net-snmp-devel OpenIPMI-devel
